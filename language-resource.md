...
When you update a model's words resource, you must train the model for the changes to take effect during transcription. For more information, see [Train the custom language model](/docs/services/speech-to-text-icp/language-create.html#trainModel).
{: note}
