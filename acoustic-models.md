...
-   [Create a custom acoustic model](/docs/services/speech-to-text-icp/acoustic-create.html#createModel-acoustic)
-   [Train the custom acoustic model](/docs/services/speech-to-text-icp/acoustic-create.html#trainModel-acoustic)
