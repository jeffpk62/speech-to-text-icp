...
-   For more information about how the service adds corpora to a model, see [What happens when you add a corpus file](/docs/services/speech-to-text-icp/language-resource.html#parseCorpus).
...
-   For more information about how the service adds custom words to a model, see [What happens when you add a custom word](/docs/services/speech-to-text-icp/language-resource.html#parseWord).
