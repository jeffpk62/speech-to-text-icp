...
If the status of a custom model's training is `failed`, use methods of the customization interface to examine the model's words and fix any errors that you find. For more information, see [Validating a words resource](/docs/services/speech-to-text-icp/language-resource.html#validateModel).
