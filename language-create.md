...
You can also add grammars to a custom language model. Grammars restrict the service's response to only those words that are recognized by a grammar. For more information, see [Using grammars with custom language models](/docs/services/speech-to-text-icp/grammar.html).
...
-   For more information about using corpora, see [Working with corpora](/docs/services/speech-to-text-icp/language-resource.html#workingCorpora).
-   For more information about how the service adds corpora to a model, see [What happens when I add a corpus file?](/docs/services/speech-to-text-icp/language-resource.html#parseCorpus)
...
You can add a maximum of 90 thousand OOV words and 10 million total words from all sources combined. This includes words from corpora and grammars, and words that you add directly. For more information, see [How much data do I need?](/docs/services/speech-to-text-icp/language-resource.html#wordsResourceAmount)
{: note}
...
-   For more information about adding words directly, see [Working with custom words](/docs/services/speech-to-text-icp/language-resource.html#workingWords).
-   For more information about how the service adds custom words to a model, see [What happens when I add or modify a custom word?](/docs/services/speech-to-text-icp/language-resource.html#parseWord)
...
Use a loop to check the status every 10 seconds until it becomes `available`. For more information about checking the status of a custom model, see [Listing custom language models](/docs/services/speech-to-text-icp/language-models.html#listModels-language).
...
-   Use methods of the customization interface to examine the model's resources and fix any errors that you find:
    ...
    For more information about validating the words in a custom language model, see [Validating a words resource](/docs/services/speech-to-text-icp/language-resource.html#validateModel).
