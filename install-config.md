...
| `global.sttModels.jaJpBroadbandModel.enabled`             | Enables/disables jp-JP Broadband Model for the service.                                                                                                                                                                                               | `True`                                                    |
| `global.sttModels.jaJpNarrowbandModel.enabled`            | Enables/disables jp-JP Narrowband Model for the service.                                                                                                                                                                                              | `True`                                                    |
| `global.sttModels.koKrBroadbandModel.enabled`             | Enables/disables ko-KR Broadband Model for the service.                                                                                                                                                                                               | `True`                                                    |
| `global.sttModels.koKrNarrowbandModel.enabled`            | Enables/disables ko-KR Narrowband Model for the service.                                                                                                                                                                                              | `True`                                                    |
