...
-   For the [WebSocket interface](/docs/services/speech-to-text-icp/websockets.html), you first specify the customization ID with the `language_customization_id` parameter of the `/v1/recognize` method. You use this method to establish a WebSocket connection with the service.
    ...
    ```
    {: codeblock}
-   For the [synchronous HTTP interface](/docs/services/speech-to-text-icp/http.html), pass both parameters with the `POST /v1/recognize` method.
    ...
    ```
    {: pre}
-   For the [asynchronous HTTP interface](/docs/services/speech-to-text-icp/async.html), pass both parameters with the `POST /v1/recognitions` method.
