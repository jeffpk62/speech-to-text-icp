...
-   [Create a custom language model](/docs/services/speech-to-text-icp/language-create.html#createModel-language)
-   [Train the custom language model](/docs/services/speech-to-text-icp/language-create.html#trainModel-language)
