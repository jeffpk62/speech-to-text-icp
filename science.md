...
{{site.data.keyword.IBM}} {{site.data.keyword.speechtotextshort}} pioneered speech recognition and audio generation research and systems since the early 1960s. The following research and academic papers are especially relevant to the technical foundations of {{site.data.keyword.ibmwatson}} {{site.data.keyword.speechtotextshort}}: Customer Care.
{: shortdesc}
